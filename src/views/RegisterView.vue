<template>
  <div class="min-h-[80vh] flex top-16  items-center justify-center px-4 py-12 relative overflow-hidden">
    <!-- Animated Background -->
      ...
      <form class="mt-8 space-y-6" @submit.prevent="handleRegister">
        <div class="space-y-4">
          ...
          <div>
            <label for="full-name" class="block text-sm font-medium text-gray-700 mb-1">
              <i data-lucide="user" class="w-4 h-4 inline-block mr-1 text-amber-600"></i>
              Full Name
            </label>
            <div class="relative">
              <i
        ...
        <div>
          <button
            type="button"
            @click="connectWallet"
            class="w-full flex items-center justify-center space-x-2 py-3 px-4 border-2 border-amber-200 rounded-xl text-amber-700 hover:bg-amber-50 transition-all group"
          >
